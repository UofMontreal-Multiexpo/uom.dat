...
<center>
![](./frequent_itemsets/list_of_transactions.png){class=table}
</center>
...
<center>
![](./frequent_itemsets/list_of_transactions.png){class=table} ![](./frequent_itemsets/lattice_2-with_occurrences.png){class=right_lattice}
</center>
...
<center>
![](./frequent_itemsets/list_of_transactions_2.png){class=table} ![](./frequent_itemsets/lattice_3-with_classes.png){class=right_lattice}
</center>
...
<center>
![](./frequent_itemsets/list_of_transactions_2.png){class=table} ![](./frequent_itemsets/lattice_4-with_classes_and_closed.png){class=right_lattice}
</center>
...
<center>
![](./frequent_itemsets/list_of_transactions.png){class=table} ![](./frequent_itemsets/lattice_5-with_maximals_wo_links.png){class=right_lattice}
</center>
...
<center>
![](./frequent_itemsets/list_of_transactions.png){class=table} ![](./frequent_itemsets/lattice_6-summary.png){class=right_lattice}
</center>
