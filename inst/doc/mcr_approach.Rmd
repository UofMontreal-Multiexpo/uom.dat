...
Foremost, we will create for our example a list of transactions as presented in the document [Transaction sets](./transaction_sets.html). For short, these transactions will simply group data from a dataset. The values we will use will be taken from these transactions.
```{r}
