...
For both functions, a `levels` parameter can be used to get the complete table, i.e. with component names that do not produce any top hazard quotient:
```{r}
...
Before starting this section, we will name the sets of concentration values created in section [1.1. Effective values](#effective-values) to better identify them:
```{r}
