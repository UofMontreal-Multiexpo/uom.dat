...
```
![Fig. 4: Spectrum of patterns.](./spectral_analysis_example/spectrum_of_patterns.png)
...
```
![Fig. 6 : Multi-association tree.](./spectral_analysis_example/multi-association_tree.png)
...
Saving pattern characteristics in a CSV file...
```{r}
save_characteristics(sa_object, tree,
                     file = paste0(directory, "multi-association_tree.csv"),
                     row.names = FALSE)

tree
```
![](./spectral_analysis_example/multi-association_tree_patterns.png)
