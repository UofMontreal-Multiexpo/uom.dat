...
spectrosome <- spectrosome_chart(another_sa_object, "patterns", another_sa_object["patterns"],
...
```{r}
patterns <- get_complexes(another_sa_object, "patterns", another_sa_object["patterns"],
                          category = "family", condition = "vertices")

spectrosome <- spectrosome_chart(another_sa_object, "patterns", patterns,
