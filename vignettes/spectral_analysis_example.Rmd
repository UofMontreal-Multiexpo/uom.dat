...
other_substances <- sort(unique(unlist(sapply(other_obs, "[", "CODE"))))
...
spectrosome <- spectrosome_chart(another_sa_object, another_sa_object["patterns"],
...
spectrosome <- spectrosome_chart(another_sa_object, patterns,
