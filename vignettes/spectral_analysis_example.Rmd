...
Loading the class allowing spectral analysis...
```{r}
...
Use of the default values (see *spectral_analyser.R* file, *spectral.analyzer()* function)...
```{r}
...
save_characteristics(sa_object, "nodes",
                     ...
                     row.names = FALSE)
# Actually the vertices of this spectrosome are exactly the nodes already saved before as "sao.nodes.csv" in section 1.4.
```
...
![Fig. 6: Pattern cluster of 3146.](./output/spec_patterns/pattern_cluster_of_3146.png)
...
```
![Fig. 7: Spectrum of patterns with weigh filter.](./img/spectrum_of_patterns_w3.png)
...
```
![Fig. 8: Spectrosome of the patterns with weight filter.](./output/spec_filter/spectrosome_of_patterns-w3.png)
...
```
![Fig. 9: Spectrum of patterns with stauts filter.](./img/spectrum_of_patterns_persistent.png)
...
```
![Fig. 10: Spectrosome of the patterns with status filter.](./output/spec_filter/spectrosome_of_patterns-Persistent.png)
...
```
![Fig. 11: Spectrosome of the patterns containing at least one substance related to the family named "Chrome".](./output/spec_family/spectrosome_of_patterns-Chrome-vertices.png)
...
```
![Fig. 12: Spectrosome of the patterns generating at least one link related to the family named "Chrome".](./output/spec_family/spectrosome_of_patterns-Chrome-edges.png)
